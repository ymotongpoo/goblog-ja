...
その結果が[型エイリアス](https://golang.org/design/18130-type-alias)が[Go 1.9で導入される](https://beta.golang.org/doc/go1.9#language)ことであり、これによってGoがより大きな規模のコードベースにスケールする助けとなるでしょう。
